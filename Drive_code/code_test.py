...
for name in namelist:
    for task in tasklist:
        book = pd.read_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/" + name + "_" + task + "_origin.csv", header=None)
        book2 = pd.read_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/" + name + "_" + task + "_others1.csv", header=None)
        book[0][0] = "Reference"
        print(book)
        # ----------------------------位置情報のデータを作成する--------------------------------
        ...
        book.to_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/result/" + name + "_" + task + "_origin.csv", header=None, index=None)

        df.to_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/result/" + name + "_" + task + "_optode.csv",index=None)

        # ----------------------------wave1,wave2のデータを作成する--------------------------------

        posttask = pd.read_excel("/Users/kawaratani_yuta/labo/Drive/matuoka_data/"  + name + "_post_" + task + "_oeg.xlsx",sheet_name="Sheet1", header=None)
       ...
       # prewave2 = pretask.ix[:, [1, 13, 3, 15, 17, 27, 29, 41, 31, 43, 45, 55, 57, 69, 59, 71]]
        ...
        postwave1.to_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/result/" + task + "\\" + name + "\\" + "post\\" + name + "_" + task + "_post_wave1.csv", header=False, index=False)
        postwave2.to_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/result/" + task + "\\" + name + "\\" + "post\\" + name + "_" + task + "_post_wave2.csv", header=False, index=False)
        ...
        for time in whattask:
            ...
            book1 = pd.ExcelFile("/Users/kawaratani_yuta/labo/Drive/matuoka_data/" + name + "_post_" + task + ".xlsx")
            ...
            tasktime_start.to_csv("/Users/kawaratani_yuta/labo/Drive/matuoka_data/result/" + name + "_post_" + task + "taskstarttime.csv",header=False, index=False)
